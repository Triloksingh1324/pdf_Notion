...
//       const response = await fetch("http://localhost:8080/convertToPdf", {
//         method: "POST",
//         body: formData,
//       });
...
//       // Instead of fetching the PDF, we handle it directly by initiating a download
...
//         const link = document.createElement("a");
//         link.href = url;
//         link.setAttribute("download", "filename.pdf"); // Set desired file name
//         document.body.appendChild(link);
//         link.click();
  ...
  const convertToPdf = async () => {
    try {
      ...
      for (let i = 0; i < selectedImages.length; i++) {
        ...
        const img = await pdfDoc.embedJpg(imageBytes); // Use embedJpg for JPEG images
